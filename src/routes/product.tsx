...
const modules = [
  {
    ...
    desc: "Employees search and book flights, hotels, and ground transport through a consumer-grade interface — but every result is filtered against your live travel policy before it ever appears on screen.",
    img: bookingImg,
    subs: [
  ...
  },
  {
    ...
    desc: "Define approval chains that mirror your actual org chart. Requests route automatically — to the right manager, at the right level, every time. Approvals happen in one click from email or mobile.",
    img: approvalImg,
    subs: [
  ...
  },
  {
    ...
    desc: "Capture expenses at the point of spend. Ozonex auto-matches expenses to bookings, maps costs to budget codes, and flags anomalies before they reach finance.",
    img: expenseImg,
    subs: [
  ...
  },
  {
    ...
    desc: "Build granular travel policies by department, grade, route, and spend category. Ozonex enforces them silently in the background — no policing required.",
    img: policyImg,
    subs: [
  ...
  },
  {
    ...
    desc: "Pre-built CFO-ready dashboards surface the numbers that matter: total travel spend, savings vs benchmark, policy compliance rate, and top traveller cost analysis — all exportable in one click.",
    img: analyticsImg,
    subs: [
  ...
  },
  {
    ...
    desc: "Ozonex is not a single dashboard — it is five distinct role-based environments. Each user sees exactly what their function demands, nothing more and nothing less.",
    img: accessImg,
    subs: [
    ...
    const ctx = gsap.context(() => {
      ...
      gsap.fromTo(
        ...
        { x: -60, opacity: 0 },
        {
          ...
          duration: 1.1,
          ease: "power3.out",
          scrollTrigger: { trigger: ".st-headline", start: "top 80%" },
        },
      );
      gsap.fromTo(
        ".st-para",
        { y: 30, opacity: 0 },
        {
          ...
          ease: "power3.out",
          stagger: 0.15,
          scrollTrigger: { trigger: ".st-para", start: "top 85%" },
        },
      );
      gsap.fromTo(
        ".st-stat",
        { y: 40, opacity: 0 },
        {
          ...
          ease: "power3.out",
          stagger: 0.1,
          scrollTrigger: { trigger: ".st-stats", start: "top 85%" },
        },
      );
      // Count up
      ...
      gsap.fromTo(
        ...
        { y: 40, opacity: 0 },
        {
          ...
          ease: "power3.out",
          stagger: 0.12,
          scrollTrigger: { trigger: ".cw-section", start: "top 70%" },
        },
      );
      gsap.to(".cw-diagram", {
        rotation: 360,
  ...
  return (
    <main className="relative">
      ...
      >
        ...
        <div className="relative z-10 min-h-screen flex flex-col items-center justify-center text-center px-6 py-32">
          ...
          <h1
            ...
            style={{ fontSize: "clamp(56px,8vw,96px)", lineHeight: 0.92 }}
          >
            {[
              ["Book", "it."],
              ["Approve", "it.", "Track", "it."],
          ...
          >
            Ozonex unifies corporate travel booking, approvals, policy, and expenses into one
            platform — so your team books faster, finance sees everything live, and nothing slips
            through the cracks.
          </p>
      ...
      <section
        ...
        style={{ background: "var(--cream)", padding: "120px 24px" }}
      >
        ...
        <div className="relative max-w-[1320px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20">
          ...
          <div className="flex flex-col gap-6" style={{ maxWidth: 480 }}>
            <p
              className="st-para"
              style={{ fontSize: 16, color: "var(--muted-warm)", lineHeight: 1.8 }}
            >
              Most travel tools are booking engines dressed up as platforms. Ozonex is different —
              it is a connected intelligence layer that sits between your workforce and every travel
              decision they make.
            </p>
            <p
              className="st-para"
              style={{ fontSize: 16, color: "var(--muted-warm)", lineHeight: 1.8 }}
            >
              From the moment a trip is requested to the moment the expense report is reconciled,
              every step runs through Ozonex — automated, policy-aware, and fully auditable.
            </p>
          </div>
        </div>
        ...
        <div
          ...
          style={{ margin: "64px auto", height: 1, background: "rgba(37,99,235,0.3)" }}
        />
        ...
        <div className="st-stats relative max-w-[1320px] mx-auto grid grid-cols-2 lg:grid-cols-4 gap-12 text-center">
          {[
            ...
            { num: "In-time", suffix: "", label: "CFO spend visibility" },
          ].map((s) => (
            <div key={s.label} className="st-stat">
              <div
                className="font-display"
                style={{ fontSize: "clamp(48px,5vw,64px)", color: "var(--ink)", marginBottom: 8 }}
              >
                {s.count ? (
                  <>
                    <span className="count-up" data-to={s.num}>
                      0
                    </span>
                    {s.suffix}
                  </>
      ...
      <section
        className="cw-section relative w-full overflow-hidden grid-overlay"
        style={{ background: "var(--ink)", padding: "160px 24px 140px" }}
      >
        ...
        <div className="text-center max-w-[1320px] mx-auto">
          ...
          >
            Request to reconciliation
            <br />
            in one unbroken loop
          </h2>
        </div>
        ...
        <div className="relative max-w-[1320px] mx-auto mt-24 grid grid-cols-1 lg:grid-cols-3 gap-16 items-center">
          ...
          <div className="cw-card lg:order-1">
            <h3 className="font-display text-white" style={{ fontSize: 28 }}>
              Fully Automated
            </h3>
            <p
              className="mt-4"
              style={{ fontSize: 14, color: "rgba(255,255,255,0.65)", lineHeight: 1.7 }}
            >
              Every handoff between booking, approval, and expense happens without a single email or
              manual step.
            </p>
          </div>
          ...
          <div className="cw-card lg:order-3 lg:text-right">
            ...
            <p
              ...
              style={{ fontSize: 14, color: "rgba(255,255,255,0.65)", lineHeight: 1.7 }}
            >
              Policy is not a filter applied after search — it is baked into every layer of the
          ...
          <div className="cw-card lg:order-4">
            ...
            <p
              ...
              style={{ fontSize: 14, color: "rgba(255,255,255,0.65)", lineHeight: 1.7 }}
            >
              Travellers, managers, and finance see the same live data simultaneously. No lag, no
          ...
          <div className="cw-card lg:order-6 lg:text-right">
            ...
            <p
              ...
              style={{ fontSize: 14, color: "rgba(255,255,255,0.65)", lineHeight: 1.7 }}
            >
              From 50 travellers to 50,000 — Ozonex handles enterprise complexity without adding
      ...
      <section
        className="relative w-full overflow-hidden"
        style={{ background: "var(--cream)", padding: "140px 24px 120px" }}
      >
        ...
        <div className="text-center max-w-[900px] mx-auto">
          <h2
            className="font-display"
            style={{ fontSize: "clamp(36px,4vw,48px)", color: "var(--ink)", lineHeight: 1.05 }}
          >
            Connects with the tools
            <br />
            your enterprise already uses
          </h2>
          <p
            className="mt-6 mx-auto"
            style={{ maxWidth: 520, fontSize: 16, color: "var(--muted-warm)", lineHeight: 1.7 }}
          >
            Ozonex plugs into your existing HR, finance, and ERP stack — no rip and replace.
            Pre-built connectors for the platforms your teams depend on daily.
          </p>
        </div>
        ...
        <div className="max-w-[1320px] mx-auto mt-20 grid grid-cols-1 md:grid-cols-3 gap-16">
          {[
            [
              "HRIS Systems",
              "Connect traveller profiles directly to your HR database for automatic grade-based policy assignment.",
            ],
            [
              "ERP & Finance",
              "Push approved expenses directly to your GL with automatic cost centre and project mapping.",
            ],
            [
              "Communication",
              "Receive booking confirmations, approval requests, and alerts inside Slack or Teams.",
            ],
          ].map(([t, d]) => (
            <div key={t}>
              ...
              <p
                className="mt-4"
                style={{ fontSize: 15, color: "var(--muted-warm)", lineHeight: 1.7 }}
              >
                {d}
              </p>
            </div>
      ...
      {/* SECTION 6 — CTA */}
      <section
        className="pcta relative w-full overflow-hidden grid-overlay"
        style={{ background: "var(--ink)", height: "100vh", minHeight: 640 }}
      >
        <div
        ...
        <div className="relative z-10 h-full flex flex-col items-center justify-center text-center px-6">
          <h2
            ...
            style={{ fontSize: "clamp(56px,8vw,80px)", lineHeight: 1.0 }}
          >
            {[
              ["See", "the", "platform"],
              ["in", "motion"],
              ...
              <span key={i} className="block">
                {line.map((w, j) => (
                  <span key={j} className="pcta-word inline-block mr-3">
                    {w}
                  </span>
                ))}
              </span>
          ...
          <p
            className="pcta-btn mt-8 mx-auto"
            style={{
              maxWidth: 480,
              fontSize: 16,
              color: "rgba(255,255,255,0.7)",
          ...
          >
            A 30-minute live walkthrough shows you exactly how Ozonex would work for your org
            structure, your approval hierarchy, and your travel spend profile.
          </p>
          <div className="pcta-btn mt-10 flex flex-wrap items-center justify-center gap-4">
            <a
              href="/pricing#enquire"
              className="pill"
              style={{ background: "#2563EB", borderColor: "#2563EB", padding: "16px 48px" }}
            >
              Book a Free Demo
            </a>
            <a href="/pricing#enquire" className="pill" style={{ padding: "16px 48px" }}>
              Get the Overview
            </a>
          </div>
        </div>
      ...
      {/* SECTION 7 — FAQ */}
      <section
        className="faq-section relative w-full"
        style={{ background: "var(--cream)", padding: "120px 24px" }}
      >
        <span
          className="absolute left-12 top-1/2 -translate-y-1/2 text-lg select-none"
          style={{ color: "var(--gold)", opacity: 0.5 }}
        >
          ✦
        </span>
        <span
          className="absolute right-12 top-1/2 -translate-y-1/2 text-lg select-none"
          style={{ color: "var(--gold)", opacity: 0.5 }}
        >
          ✦
        </span>
              ...
              <div key={i} className="faq-row border-b" style={{ borderColor: "#D4C9BE" }}>
                ...
                >
                  <p
                    ...
                    style={{ fontSize: 15, color: "var(--muted-warm)", lineHeight: 1.75 }}
                  >
                    {a}
                  </p>
                </div>
