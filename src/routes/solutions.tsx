    ...
    const ctx = gsap.context(() => {
      ...
      gsap.fromTo(
        ...
        { x: -60, opacity: 0 },
        {
          ...
          duration: 1.1,
          ease: "power3.out",
          scrollTrigger: { trigger: ".se-photo", start: "top 80%" },
        },
      );
      gsap.fromTo(
        ".se-text > *",
        { x: 60, opacity: 0 },
        {
          ...
          stagger: 0.1,
          ease: "power3.out",
          scrollTrigger: { trigger: ".se-text", start: "top 80%" },
        },
      );
      ...
      gsap.fromTo(
        ...
        { y: 40, opacity: 0 },
        {
          ...
          stagger: 0.15,
          ease: "power3.out",
          scrollTrigger: { trigger: ".hr-cards", start: "top 78%" },
        },
      );
      ...
      gsap.fromTo(
        ...
        { y: 40, opacity: 0 },
        {
          ...
          duration: 1,
          ease: "power3.out",
          scrollTrigger: { trigger: ".sol-table", start: "top 80%" },
        },
      );
      ...
      gsap.fromTo(
        ...
        { x: -40, opacity: 0 },
        {
          ...
          stagger: 0.2,
          ease: "power3.out",
          scrollTrigger: { trigger: ".sol-quotes", start: "top 80%" },
        },
      );
    ...
    <main ref={root} className="relative">
      ...
      >
        ...
        <div
          className="absolute inset-0"
          style={{
            background: "linear-gradient(rgba(28,20,16,0.75) 0%, rgba(28,20,16,0.55) 100%)",
          }}
        />
        <span
          className="absolute left-4 md:left-12 top-1/2 -translate-y-1/2 text-2xl select-none z-10"
          style={{ color: "#fff", opacity: 0.35 }}
        >
          ✦
        </span>
        <span
          className="absolute right-4 md:right-12 top-1/2 -translate-y-1/2 text-2xl select-none z-10"
          style={{ color: "#fff", opacity: 0.35 }}
        >
          ✦
        </span>
        ...
        <div className="relative z-10 min-h-screen flex flex-col items-center justify-center text-center px-6 py-32">
          ...
          <h1
            ...
            style={{ fontSize: "clamp(40px,8vw,84px)", lineHeight: 0.9, fontWeight: 300 }}
          >
            {[["BUILT", "FOR", "YOUR", "TEAM."], ["NOT", "A", "GENERIC"], ["COMPANY."]].map(
              (line, i) => (
                <span key={i} className="block">
                  {line.map((w, j) => (
                    <span key={j} className="sh-word inline-block mr-2 md:mr-3">
                      {w}
                    </span>
                  ))}
                </span>
          ...
          >
            Ozonex was not built for a generic company. It was built for the specific pressures that
            enterprises, finance teams, HR departments, and growing SMBs face when corporate travel
            stops being manageable with spreadsheets.
          </p>

          <div
            className="sh-fade flex flex-wrap items-center justify-center gap-2 md:gap-3"
            style={{ marginTop: 40 }}
          >
            {[
              "Enterprises & MNCs",
      ...
      >
        <div className="se-photo relative overflow-hidden" style={{ minHeight: 320 }}>
          <img
            src={enterprisesImg}
        ...
        >
          ...
          >
            When your workforce operates across 12 time zones and your CFO needs to close the books
            by the 5th of every month, your travel platform cannot be a loose collection of booking
            portals and email threads. Ozonex gives your enterprise a single source of truth for
            every journey made.
          </p>
          <p
            style={{
          ...
          >
            Multi-entity support means each subsidiary, region, or business unit has its own policy
            set, approval hierarchy, and reporting view — while the Group admin maintains full
            oversight of consolidated spend from one dashboard.
          </p>
          <div className="flex flex-col" style={{ gap: 18, marginTop: 28 }}>
            {[
              ...
              [
                "SSO and ERP integration for enterprise IT stacks",
                "Plugs into SAP, Oracle, Workday, Okta",
              ],
            ].map(([t, d]) => (
              <div key={t} style={{ borderLeft: "2px solid #3B82F6", paddingLeft: 20 }}>
                <div
                  style={{ fontFamily: "Inter", fontSize: 14, color: "#1C1410", fontWeight: 500 }}
                >
                  {t}
                </div>
                <div style={{ fontFamily: "Inter", fontSize: 13, color: "#6B6258", marginTop: 2 }}>
                  {d}
                </div>
              </div>
            ))}
      ...
      >
        ...
        <div className="max-w-[1320px] mx-auto grid lg:grid-cols-[40fr_60fr] gap-12 lg:gap-20">
          <div style={{ alignSelf: "start" }}>
            ...
            >
              HR teams did not sign up to track who is in which country at 2am. They signed up to
              keep people safe and productive. Ozonex automates the tracking, the alerts, and the
              documentation — so your HR team is only called when a decision is actually needed.
            </p>
      ...
      >
        ...
        {/* Stats bar — 2×2 on mobile, 4 cols on lg */}
        <div
          ...
          {[
            ...
            <div
              ...
              style={{
                textAlign: "center",
                padding: "0 16px",
                borderLeft: i === 0 || i === 2 ? "none" : "1px solid rgba(37,99,235,0.2)",
              }}
            >
              <div
                className="font-display"
              ...
              >
                {s.count ? (
                  <>
                    <span className="sol-count" data-to={s.num}>
                      0
                    </span>
                    {s.suffix}
                  </>
        ...
        <div
          className="max-w-[1320px] mx-auto grid grid-cols-1 lg:grid-cols-[52fr_48fr] gap-12 lg:gap-20"
          style={{ marginTop: 80 }}
        >
          <div>
            <div
            ...
            >
              Finance teams lose hours every month to travel expense reconciliation — chasing
              receipts, correcting GL codes, manually exporting data to ERP systems. Ozonex
              eliminates every one of those steps by connecting booking approval directly to expense
            ...
            >
              Every approved booking creates an automatic cost record, assigned to the correct cost
              centre and GL code based on policy rules. When the month closes, the data is already
              in your ERP — validated, reconciled, and audit-ready.
            </p>
          </div>
          <div>
            <img
              ...
              loading="lazy"
              style={{ width: "100%", height: "auto", maxHeight: 460, objectFit: "cover" }}
            />
      ...
      >
        ...
        <div
          ...
          style={{ padding: "clamp(80px,12vw,160px) clamp(24px,6vw,80px)" }}
        >
          <div
            style={{
              color: "#2563EB",
          ...
          >
            Ozonex scales down as cleanly as it scales up. A 40-person company gets the same policy
            enforcement, approval automation, and expense intelligence as a 4,000-person enterprise
            — without paying for modules they do not need or hiring an ops team to manage it.
          </p>
          <div
            className="grid grid-cols-1 md:grid-cols-2 w-full"
            style={{ marginTop: 64, maxWidth: 800, gap: 40, textAlign: "left" }}
          >
            <div>
              <div
                style={{
      ...
      <section
        ...
        style={{
          background: "#F5F0EA",
          padding: "clamp(80px,12vw,160px) clamp(24px,6vw,80px) clamp(40px,6vw,80px)",
        }}
      >
        <div className="text-center max-w-[820px] mx-auto">
          ...
          >
            Ozonex is built to fit inside your existing enterprise architecture. SSO, ERP
            connectors, HR system sync, and API access are standard — not add-ons. Your IT team
            controls the deployment. Your ops team controls the configuration.
          </p>
        </div>

        {/* Horizontally scrollable strip — cards scale to viewport */}
        <div
          ref={stripRef}
          className="flex"
          style={{
          ...
          {[
            ...
            >
              ...
              <h3
                ...
                style={{ fontSize: 28, color: "#1C1410", fontWeight: 400, lineHeight: 1.05 }}
              >
                {c.title}
              </h3>
              <p
        ...
        <div
          ...
          style={{ height: 2, background: "rgba(37,99,235,0.15)" }}
        >
      ...
      >
        <div className="text-center max-w-[820px] mx-auto">
          ...
          >
            Whether you are a 50-person startup or a 50,000-person enterprise, Ozonex has a
            configuration built around your operational reality.
          </p>
        </div>

        {/* Wrapper enables horizontal scroll on small screens */}
        <div style={{ overflowX: "auto", WebkitOverflowScrolling: "touch", marginTop: 48 }}>
          <table
            className="sol-table mx-auto"
            style={{ width: "100%", minWidth: 560, maxWidth: 960, borderCollapse: "collapse" }}
          >
            <thead>
      ...
      >
        ...
        <div
          className="sol-quotes max-w-[1320px] mx-auto grid grid-cols-1 md:grid-cols-3"
          style={{ gap: 40 }}
        >
          {[
            [
      ...
      <section
        ...
        style={{ background: "#1C1410", minHeight: "100vh" }}
      >
        <div
        ...
        <div className="relative z-10 min-h-screen flex flex-col items-center justify-center text-center px-6 py-24">
          <h2
            className="font-display text-white"
            style={{ fontSize: "clamp(44px,8vw,88px)", lineHeight: 1.0, fontWeight: 300 }}
          >
            {[["FIND", "YOUR", "FIT."], ["BOOK", "A", "LIVE"], ["WALKTHROUGH."]].map((line, i) => (
              <span key={i} className="block">
                {line.map((w, j) => (
                  <span key={j} className="scta-word inline-block mr-2 md:mr-3">
                    {w}
                  </span>
                ))}
              </span>
          ...
          >
            Tell us your org size, your current travel pain points, and your team structure. We will
            show you exactly how Ozonex would work for your specific operation — not a generic demo.
          </p>
          <div
            className="scta-btn flex flex-wrap items-center justify-center"
