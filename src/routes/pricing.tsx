...
const offices = [
  { city: "Trivandrum", flag: "🇮🇳", detail: "Head Office — Surya Hills, near Technopark, Kazhakkoottam PO, Kerala 695582", phone: "+91 471 3500 598" },
  { city: "Chennai", flag: "🇮🇳", detail: "New No. 12, First Floor, Thambiah Road, West Mambalam, Chennai 600033", phone: "+91 44 3130 2651" },
...
const services = ["Corporate Travel Management", "Flight Booking", "Hotel Booking", "Visa Assistance", "MICE", "Other"];
...
function PricingPage() {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      gsap.fromTo(".form-card", { y: 60, opacity: 0 }, { y: 0, opacity: 1, duration: 1, ease: "power3.out", scrollTrigger: { trigger: ".form-card", start: "top 80%" } });
      gsap.fromTo(".info-card", { y: 40, opacity: 0 }, { y: 0, opacity: 1, duration: 0.8, ease: "power3.out", stagger: 0.1, scrollTrigger: { trigger: ".info-section", start: "top 80%" } });
  ...
  return (
    <main className="relative">
      ...
      {/* HERO */}
      <section className="relative w-full min-h-[70vh] overflow-hidden grid-overlay flex flex-col items-center justify-center text-center px-6 py-40" style={{ background: "var(--ink)" }}>
        ...
        <div className="hero-eyebrow eyebrow" style={{ color: "rgba(255,255,255,0.5)" }}>Pricing & Enquiries</div>

        <h1 className="font-display mt-8 text-white" style={{ fontSize: "clamp(48px,7vw,88px)", lineHeight: 0.95 }}>
          {[["Pricing", "built"], ["around", "you."]].map((line, i) => (
        ...
        <p className="hero-fade mt-10 mx-auto" style={{ maxWidth: 520, fontSize: 17, color: "rgba(255,255,255,0.65)", lineHeight: 1.8 }}>
          No off-the-shelf tiers. Every Ozonex plan is tailored to your organisation's size, travel policy complexity, and operational requirements. Tell us about your programme and we'll get back within one business day.
        </p>
        ...
        <div className="hero-fade mt-8 flex flex-wrap justify-center gap-6" style={{ fontSize: 13, color: "rgba(255,255,255,0.45)", letterSpacing: "0.08em" }}>
          {["IATA Certified", "Est. 2014", "5 Countries"].map((t) => (
      ...
      <section id="enquire" className="relative w-full" style={{ background: "var(--cream)", padding: "100px 24px 120px", scrollMarginTop: "80px" }}>
        <div className="max-w-[1320px] mx-auto grid grid-cols-1 lg:grid-cols-[1fr_420px] gap-16 items-start">
          ...
          {/* FORM */}
          <div className="form-card" style={{ background: "#fff", borderRadius: 20, padding: "56px 48px", boxShadow: "0 4px 40px rgba(28,20,16,0.08)" }}>
            <div className="eyebrow" style={{ color: "var(--gold)" }}>Send us an enquiry</div>
            <h2 className="font-display mt-4" style={{ fontSize: "clamp(28px,3vw,40px)", color: "var(--ink)", lineHeight: 1.1 }}>
              Let's talk about<br />your travel programme
            </h2>
            <p className="mt-4" style={{ fontSize: 14, color: "var(--muted-warm)", lineHeight: 1.7 }}>
              Fill in the form and a member of our enterprise team will reach out within one business day.
            </p>
            ...
            <div className="mt-8 flex flex-col sm:flex-row items-start sm:items-center gap-6">
              ...
              <p style={{ fontSize: 12, color: "var(--muted-warm)", lineHeight: 1.6, maxWidth: 280 }}>
          ...
          <div className="info-section flex flex-col gap-8">
            <div className="info-card" style={{ background: "var(--ink)", borderRadius: 16, padding: "36px 32px" }}>
              ...
              <div className="mt-6 flex flex-col gap-5">
                <a href={`mailto:${CONTACT_EMAIL}`} className="flex items-start gap-3" style={{ color: "rgba(255,255,255,0.8)", fontSize: 14, textDecoration: "none" }}>
                  <span style={{ color: "var(--gold)", marginTop: 2 }}>✉</span>
                  <span>{CONTACT_EMAIL}</span>
                </a>
                <a href="https://wa.me/918139831118" target="_blank" rel="noopener noreferrer" className="flex items-start gap-3" style={{ color: "rgba(255,255,255,0.8)", fontSize: 14, textDecoration: "none" }}>
                  <span style={{ color: "var(--gold)", marginTop: 2 }}>💬</span>
                  <span>WhatsApp: +91 81398 31118</span>
                </a>
                <a href="tel:+914713500598" className="flex items-start gap-3" style={{ color: "rgba(255,255,255,0.8)", fontSize: 14, textDecoration: "none" }}>
                  <span style={{ color: "var(--gold)", marginTop: 2 }}>✆</span>
              ...
              <div className="mt-6 flex flex-col gap-5">
                {[
                  ...
                  <div key={n} className="flex gap-4">
                    <span className="font-display" style={{ fontSize: 28, color: "var(--ink)", opacity: 0.15, lineHeight: 1, minWidth: 36 }}>{n}</span>
      ...
      {/* OFFICES */}
      <section className="offices-section relative w-full overflow-hidden" style={{ background: "var(--ink)", padding: "120px 24px" }}>
        <TornEdge fill="var(--ink)" position="top" />

        <div className="text-center max-w-[1320px] mx-auto">
          <div className="eyebrow" style={{ color: "rgba(255,255,255,0.4)" }}>Our offices</div>
          <h2 className="font-display mt-6 text-white" style={{ fontSize: "clamp(36px,4vw,56px)", lineHeight: 1.05 }}>
            We're where<br />your business travels
          </h2>
        </div>

        <div className="max-w-[1320px] mx-auto mt-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {offices.map((o) => (
            <div key={o.city} className="office-card" style={{ border: "1px solid rgba(255,255,255,0.1)", borderRadius: 16, padding: "32px 28px" }}>
