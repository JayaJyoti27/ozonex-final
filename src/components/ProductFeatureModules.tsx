...
/* =========================================================================
   PRODUCT — SECTION 3 (REPLACEMENT)
   Six feature modules, every one a different layout pattern.
========================================================================= */
...
export function ProductFeatureModules() {
  ...
  return (
    <div ref={root}>
      ...
      {/* ============== MODULE 2 — Approvals (dark, pinned) ============== */}
      <Module2 />

      {/* ============== MODULE 3 — Expenses ============== */}
      <Module3 />

      {/* ============== MODULE 4 — Policy (dark) ============== */}
      <Module4 />

      {/* ============== MODULE 5 — Analytics ============== */}
      <Module5 />

      {/* ============== MODULE 6 — Access (dark) ============== */}
      <Module6 />
    </div>
  );
}
...
/* ------------------------------------------------------------ */
/* MODULE 1 — Smart Booking — sticky left + flip cards right    */
/* ------------------------------------------------------------ */
function Module1() {
  const cards = [
    {
  ...
  return (
    ...
    >
      ...
      >
        <h4
          className="font-display"
          style={{ fontSize: 28, color: "#1C1410", fontWeight: 400 }}
        >
          {title}
        </h4>
        <p
...
/* ------------------------------------------------------------ */
/* MODULE 2 — Approval Workflow — pinned horizontal              */
/* ------------------------------------------------------------ */
function Module2() {
  const panels = [
    {
...
/* ------------------------------------------------------------ */
/* MODULE 3 — Expense Tracking — sticky text + animated dashboard */
/* ------------------------------------------------------------ */
function Module3() {
  return (
    <section
    ...
    >
      ...
      <div className="max-w-[1320px] mx-auto grid lg:grid-cols-[44fr_56fr] gap-20">
        <div className="lg:sticky" style={{ top: 120, alignSelf: "start" }}>
          ...
          <h3
            className="font-display"
            style={{ fontSize: 56, color: "#1C1410", lineHeight: 0.95, fontWeight: 300 }}
          >
            EXPENSES CLOSE
            <br />
            THEMSELVES.
          ...
          >
            Ozonex captures spend at the point of transaction. Receipts are
            matched to bookings automatically using OCR and booking reference
            matching. By the time the trip ends, the expense report is already
          ...
          <div style={{ marginTop: 32 }}>
            {[
              ...
              ["Zero", "manual receipt matching for pre-approved bookings"],
            ].map(([n, l]) => (
              <div
                key={l}
                style={{
        ...
        >
          ...
          <div style={{ marginTop: 32, display: "flex", alignItems: "baseline", gap: 6 }}>
            <span style={{ fontFamily: "Inter", fontSize: 20, color: "#1C1410" }}>₹</span>
            <span
              className="font-display pfm-count"
              data-to="4280000"
              data-fmt="comma"
              style={{ fontSize: 64, color: "#1C1410", lineHeight: 1, fontWeight: 300 }}
            >
              0
            </span>
          </div>
          <div style={{ fontFamily: "Inter", fontSize: 12, color: "#6B6258", marginTop: 4 }}>
          ...
          <div className="grid grid-cols-3" style={{ gap: 12, marginTop: 32 }}>
            <div style={{ border: "1px solid rgba(37,99,235,0.15)", padding: 20 }}>
              <svg width="64" height="64" viewBox="0 0 64 64">
                ...
                <text
                  ...
                  y="36"
                  textAnchor="middle"
                  style={{ fontFamily: "Inter", fontSize: 14, fontWeight: 500, fill: "#1C1410" }}
                >
                  94%
                </text>
              </svg>
            ...
            <div style={{ border: "1px solid rgba(37,99,235,0.15)", padding: 20 }}>
              <div
                className="font-display pfm-count"
                data-to="847"
                style={{ fontSize: 32, color: "#1C1410", lineHeight: 1, fontWeight: 300 }}
              >
                0
              </div>
              <div style={{ fontFamily: "Inter", fontSize: 11, color: "#6B6258", marginTop: 4 }}>
                auto-matched this quarter
              </div>
              <div
                style={{
                  marginTop: 12,
          ...
          <div style={{ marginTop: 40 }}>
            ...
            {[
              ...
              <div
                key={t}
                className="m3-row grid items-center"
                style={{
                  gridTemplateColumns: "1.4fr 1.6fr 1fr 1fr",
                  fontFamily: "Inter",
                  fontSize: 13,
...
/* ------------------------------------------------------------ */
/* MODULE 4 — Policy Mgmt — sticky left + accordion right (dark) */
/* ------------------------------------------------------------ */
function Module4() {
  const items = [
    [
    ...
    >
      ...
      <div className="max-w-[1320px] mx-auto grid lg:grid-cols-[44fr_56fr] gap-20">
        <div className="lg:sticky" style={{ top: 120, alignSelf: "start" }}>
          ...
          <h3
            className="font-display"
            style={{ fontSize: 56, color: "#fff", lineHeight: 0.95, fontWeight: 300 }}
          >
            YOUR RULES.
            <br />
            ENFORCED
            ...
            return (
              ...
              >
                ...
                >
                  <span
                    className="font-display"
                    style={{ fontSize: 24, color: "#fff", fontWeight: 400 }}
                  >
                    {title}
                  </span>
                  <ChevronDown
  ...
  return (
    ...
    >
      ...
      <div className="max-w-[1320px] mx-auto" style={{ marginTop: 80 }}>
        ...
        <div
          key={active}
          className="grid lg:grid-cols-[48fr_52fr] items-start"
          style={{
            gap: 80,
            paddingTop: 60,
            minHeight: 480,
...
function TabText({ h, body, bullets }: { h: string; body: string; bullets: string[] }) {
  return (
    <div>
      <h4 className="font-display" style={{ fontSize: 36, color: "#1C1410", lineHeight: 1.1, fontWeight: 400 }}>
        {h}
      </h4>
      <p
        style={{
...
function CFOTab() {
  return (
    <>
      <TabText
        h="Total command of every travel rupee spent."
      ...
      <MockShell>
        <div className="grid grid-cols-2" style={{ gap: 16 }}>
          <div style={{ border: "1px solid rgba(37,99,235,0.15)", padding: 20 }}>
            ...
            <div style={{ fontFamily: "Inter", fontSize: 11, color: "#6B6258", marginTop: 6 }}>
              Total Spend Q2
            </div>
          </div>
          <div style={{ border: "1px solid rgba(37,99,235,0.15)", padding: 20 }}>
        ...
        <div className="flex items-center" style={{ gap: 32, marginTop: 32 }}>
          <svg width="160" height="160" viewBox="0 0 160 160">
            ...
            <text
              ...
              y="84"
              textAnchor="middle"
              style={{ fontFamily: "Inter", fontSize: 9, fill: "#6B6258" }}
            >
              Spend by Category
            </text>
          </svg>
          <div className="flex flex-col" style={{ gap: 10 }}>
            {[
              ...
              <div key={l} className="flex items-center" style={{ gap: 8 }}>
                ...
                <span style={{ fontFamily: "Inter", fontSize: 11, color: "#1C1410" }}>{l}</span>
              </div>
            ))}
          </div>
        </div>
          ...
          {[
            ...
            <g key={p.l}>
              ...
              <text
                ...
                y={p.y + 22}
                textAnchor="middle"
                style={{ fontFamily: "Inter", fontSize: 9, fill: "#fff" }}
              >
                {p.l}
              </text>
            </g>
...
function ManagerTab() {
  ...
  return (
    <>
      ...
      />
      <MockShell>
        <div style={{ fontFamily: "Inter", fontSize: 11, color: "#6B6258", marginBottom: 24 }}>
...
function FinanceTab() {
  return (
    <>
      ...
      />
      <MockShell>
        <div style={{ fontFamily: "Inter", fontSize: 11, color: "#6B6258", marginBottom: 16 }}>
...
function Module6() {
  const roles = [
    ...
    [
      "EMPLOYEE",
      "E",
      "Policy-filtered self-booking portal. Mobile expense submission with receipt OCR. Full trip history and documents. Approval status tracking. 24/7 support access.",
    ],
  ];
  return (
    <section
    ...
    >
      ...
      <div
        className="m6-grid max-w-[1320px] mx-auto grid grid-cols-1 md:grid-cols-5"
  ...
  return (
    ...
    >
      ...
      <h4
        ...
        style={{ fontSize: 32, color: "#fff", fontWeight: 300, lineHeight: 1 }}
      >
        {role}
      </h4>
      <p
